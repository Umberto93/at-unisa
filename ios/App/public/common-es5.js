(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    "tPuo":
    /*!***************************************************!*\
      !*** ./src/app/services/esse3/tax/tax.service.ts ***!
      \***************************************************/

    /*! exports provided: TaxService */

    /***/
    function tPuo(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var TaxService = /*#__PURE__*/function () {
        function TaxService(http) {
          ...
          this.http = http;
          this.base = "".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].esse3Api, "/tasse-service-v1");
        }
        /**
        ...
        _createClass(TaxService, [{
          ...
          key: "getTax",
          value: function getTax(persId) {
            var _this = this;

            return this.http.get("".concat(this.base, "/lista-fatture"), {
              params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('persId', "".concat(persId))
              ...
              res.forEach(function (el) {
                el.importoFattura > 0 && taxs.push({
                  ...
                  paymentDate: _this.toDate(el.dataPagamento.split(' ')[0]),
                  expirationDate: _this.toDate(el.scadFattura.split(' ')[0]),
      ...
      TaxService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], TaxService);
      /***/
    }
