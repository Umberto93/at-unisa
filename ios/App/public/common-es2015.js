...
let TaxService = class TaxService {
    constructor(http) {
        this.http = http;
        this.base = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].esse3Api}/tasse-service-v1`;
    }
    /**
     ...
     */
    getTax(persId) {
        return this.http.get(`${this.base}/lista-fatture`, {
...
TaxService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
