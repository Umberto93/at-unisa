...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".page-title {\n  margin: 47px 0;\n}\n\nion-img {\n  height: 241px;\n}\n\nform ion-list {\n  padding-top: 0;\n  padding-bottom: 0;\n}\n\n.form-control {\n  margin-bottom: 30px;\n}\n\n.form-control ion-input {\n  --padding-start: 20px;\n  font-size: 14px;\n}\n\n.form-control__icon:last-of-type {\n  cursor: pointer;\n}\n\n.form-options {\n  --min-height: auto;\n  font-size: 14px;\n}\n\n.form-options ion-checkbox {\n  margin-right: 10px;\n}\n\n.form-submit--round {\n  display: block;\n  height: 60px;\n  width: 60px;\n  margin-top: 47px;\n  margin-left: auto;\n  --border-radius: 50%;\n  transition: opacity var(--ion-transition-fast);\n}\n\n.form-submit__icon {\n  color: white;\n  font-size: 18px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let LoginPage = class LoginPage {
    constructor(router, formBuilder, auth, toastService) {
        this.router = router;
        ...
        this.loginForm = this.formBuilder.group({
            username: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].compose([
                ...
                _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].pattern(/^[a-z]{1}\.[a-z0-9]+$/i)
            ])),
    ...
    login() {
        if (this.loginForm.valid) {
            this.loginSubscription = this.auth.loginWithCredentials(this.loginForm.value.username, this.loginForm.value.password).subscribe(() => { }, err => {
                throw err;
            }, () => {
...
let AuthService = class AuthService {
    ...
    loginWithCredentials(username, password) {
        ...
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].esse3Api}/login`, {
